...
@Inject
class AddFeatureRequestCommentUseCase(
	private val repository: FeatureRequestsRepository,
) {

	suspend operator fun invoke(requestId: Int, body: String): Outcome<FeatureRequestComment> {
		return repository.addFeatureRequestComment(requestId, body.trim())
	}
}
