		...
		private fun ensureSchema(dataSource: DataSource) {
			dataSource.connection.use { connection ->
				connection.createStatement().use { statement ->
					...
					statement.execute(FEATURE_REQUESTS_TABLE_SQL)
					statement.execute(FEATURE_REQUESTS_STATUS_CREATED_AT_INDEX_SQL)
					statement.execute(FEATURE_REQUEST_VOTES_TABLE_SQL)
					statement.execute(FEATURE_REQUEST_VOTES_REQUEST_INDEX_SQL)
					statement.execute(FEATURE_REQUEST_COMMENTS_TABLE_SQL)
					statement.execute(FEATURE_REQUEST_COMMENTS_REQUEST_INDEX_SQL)
