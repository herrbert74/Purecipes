...
let package = Package(
  ...
  dependencies: [
    ...
    .package(path: "subpackages/_feature_featurerequests_data"),
    ...
    .package(path: "subpackages/_feature_onboarding_data"),
  ...
  targets: [
    .target(
      ...
      dependencies: [
        ...
        .product(name: "_feature_featurerequests_data", package: "_feature_featurerequests_data"),
        ...
        .product(name: "_feature_onboarding_data", package: "_feature_onboarding_data"),
