...
let package = Package(
  ...
  dependencies: [
    ...
    .package(path: "subpackages/_feature_favorites_data"),
    .package(path: "subpackages/_feature_favorites_ui"),
  ...
  targets: [
    .target(
      ...
      dependencies: [
        ...
        .product(name: "_feature_favorites_data", package: "_feature_favorites_data"),
        .product(name: "_feature_favorites_ui", package: "_feature_favorites_ui"),
