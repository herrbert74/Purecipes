...
internal object SeedExamples {
	...
	val cuisine: Map<Cuisine, List<String>> = mapOf(
		Cuisine.AMERICAN to listOf("classic american burger and fries", "southern mac and cheese", "barbecue ribs and coleslaw"),
		Cuisine.ARGENTINE to listOf("chimichurri steak and empanadas", "argentine grilled beef", "provoleta and asado"),
		Cuisine.BANGLADESHI to listOf("bangladeshi fish curry and bhuna", "dal with mustard oil and green chilli", "bengali style rice and curry"),
		Cuisine.BRAZILIAN to listOf("feijoada with black beans and pork", "pao de queijo cheese bread", "brazilian grilled meat and rice"),
		Cuisine.BRITISH to listOf("shepherds pie and gravy", "fish and chips", "yorkshire pudding roast dinner"),
		Cuisine.CARIBBEAN to listOf("jerk chicken with rice and peas", "caribbean curry goat", "plantain and island spices"),
		Cuisine.CHINESE to listOf("kung pao chicken stir fry", "dumplings with soy sauce", "fried rice and noodles"),
		Cuisine.EASTERN_EUROPEAN to listOf("pierogi and cabbage", "goulash with paprika", "hearty eastern european stew"),
		Cuisine.ETHIOPIAN to listOf("injera with lentil wats", "ethiopian berbere stew", "spiced ethiopian platter"),
		Cuisine.FILIPINO to listOf("chicken adobo with rice", "filipino pancit noodles", "sinigang tamarind soup"),
		Cuisine.FRENCH to listOf("coq au vin", "ratatouille with herbs", "french onion soup"),
		Cuisine.GERMAN to listOf("bratwurst with sauerkraut", "german potato salad", "schnitzel and spaetzle"),
		Cuisine.GREEK to listOf("greek salad with feta", "moussaka and tzatziki", "lemony souvlaki and olives"),
		Cuisine.INDIAN to listOf("chicken tikka masala", "dal and naan", "spiced indian curry"),
		Cuisine.INDONESIAN to listOf("nasi goreng fried rice", "satay skewers with peanut sauce", "rendang and sambal"),
		Cuisine.ITALIAN to listOf("spaghetti carbonara", "margherita pizza", "risotto with parmesan"),
		Cuisine.JAPANESE to listOf("miso soup and sushi", "teriyaki chicken", "japanese ramen bowl"),
		Cuisine.KOREAN to listOf("kimchi fried rice", "bulgogi beef", "gochujang korean stew"),
		Cuisine.MALAYSIAN to listOf("laksa noodle soup", "malaysian coconut curry", "nasi lemak with sambal"),
		Cuisine.MEDITERRANEAN to listOf("olive oil roasted vegetables", "mediterranean chickpea salad", "grilled fish with lemon and herbs"),
		Cuisine.MEXICAN to listOf("tacos with salsa", "enchiladas and beans", "mexican chilli and tortillas"),
		Cuisine.MIDDLE_EASTERN to listOf("falafel and hummus", "shawarma with tahini", "middle eastern spiced rice"),
		Cuisine.NORTH_AFRICAN to listOf("tagine with apricots", "harissa roasted vegetables", "couscous and north african spices"),
		Cuisine.PAKISTANI to listOf("pakistani biryani", "nihari and naan", "karahi curry with spices"),
		Cuisine.PERUVIAN to listOf("ceviche with lime", "peruvian roast chicken", "aji amarillo sauce"),
		Cuisine.PORTUGUESE to listOf("portuguese seafood rice", "peri peri chicken", "bacalhau salt cod"),
		Cuisine.RUSSIAN to listOf("borscht beet soup", "beef stroganoff", "russian dumplings and sour cream"),
		Cuisine.SPANISH to listOf("paella with saffron", "patatas bravas", "spanish tortilla and tapas"),
		Cuisine.THAI to listOf("thai green curry", "pad thai noodles", "lemongrass coconut soup"),
		Cuisine.TURKISH to listOf("turkish kebab and pide", "mercimek lentil soup", "yogurt and sumac mezze"),
		Cuisine.VIETNAMESE to listOf("pho noodle soup", "banh mi sandwich", "fresh vietnamese spring rolls"),
		Cuisine.WEST_AFRICAN to listOf("jollof rice and stew", "west african peanut soup", "spicy plantain and bean dishes"),
	)
