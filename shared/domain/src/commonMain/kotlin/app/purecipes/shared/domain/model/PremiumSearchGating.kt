...
// When true, the backend applies keyIngredients and premium filters (calories,
// nutrition) from the search request even if the user is not premium in the
// database. The client still paywalls these features until Monetisation debug
// Force Premium (or a real subscription) sets isPremium.
