...
import com.purecipes.shared.data.util.runCatchingUnit
 ...
 * the network request may expose metadata (for example via a Ktor [io.ktor.client.statement.HttpResponse])
 * if headers or error bodies are required.
 *
