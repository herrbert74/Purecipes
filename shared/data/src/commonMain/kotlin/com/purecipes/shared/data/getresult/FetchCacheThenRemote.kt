...
import com.purecipes.shared.data.getresult.STRATEGY.CACHE_FIRST_NETWORK_LATER
import com.purecipes.shared.data.getresult.STRATEGY.CACHE_FIRST_NETWORK_ONCE
import com.purecipes.shared.data.getresult.STRATEGY.CACHE_FIRST_NETWORK_SECOND
 ...
 *
 * @param shouldMakeNetworkRequest Whether to make network request.
 *
 * @param makeNetworkRequest A function to make network request and retrieve data mapped to [DOMAIN].
 * [de.jensklingenberg.ktorfit.Response] can be used as part of the call. It is needed when we want to extract information from the
